...
PIPE_PATH = "/tmp/server3_pipe"  # Pipe for metrics
LOG_PATH = "/tmp/server3_log.json"  # Log for historical data
...
if __name__ == "__main__":
    ...
    app.run(debug=True, host='10.0.2.4', port=5000)  # Runs HTTP server and restricts access to client only
